"""
Django settings for mytest_45186 project.
...
ROOT_URLCONF = 'mytest_45186.urls'
...
WSGI_APPLICATION = 'mytest_45186.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mytest_45186 API",
    "DESCRIPTION": "API documentation for mytest_45186 App",
    "VERSION": "v1",
}
